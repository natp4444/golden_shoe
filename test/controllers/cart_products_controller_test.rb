...
class CartProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cart_product" do
    assert_difference('CartProduct.count') do
      post cart_products_url, params: { cart_product: { cart_id: @cart_product.cart_id, product_id: @cart_product.product_id } }
    end
  ...
  test "should update cart_product" do
    patch cart_product_url(@cart_product), params: { cart_product: { cart_id: @cart_product.cart_id, product_id: @cart_product.product_id } }
