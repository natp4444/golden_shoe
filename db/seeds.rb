...
product.avatar.attach(io: File.open('app/assets/images/product_images/birkenstock.jpg'), filename: 'birkenstock.jpg')
...
product.avatar.attach(io: File.open('app/assets/images/product_images/beaded_sandals.jpg'), filename: 'beaded_sandals.jpg')
...
product.avatar.attach(io: File.open('app/assets/images/product_images/brogues.jpg'), filename: 'brogues.jpg')
...
product.avatar.attach(io: File.open('app/assets/images/product_images/brown_boot.jpg'), filename: 'brown_boot.jpg')
...
product.avatar.attach(io: File.open('app/assets/images/product_images/brown_nike.jpg'), filename: 'brown_nike.jpg')
...
product.avatar.attach(io: File.open('app/assets/images/product_images/diamante_heels.jpg'), filename: 'diamante_heels.jpg')
...
product.avatar.attach(io: File.open('app/assets/images/product_images/floral_heels.jpg'), filename: 'diamante_heels.jpg')
...
product.avatar.attach(io: File.open('app/assets/images/product_images/green_nike.jpg'), filename: 'green_nike.jpg')
...
product.avatar.attach(io: File.open('app/assets/images/product_images/nude_heels.jpg'), filename: 'nude_heels.jpg')
...
product.avatar.attach(io: File.open('app/assets/images/product_images/pastel_block_heel.jpg'), filename: 'pastel_block_heel.jpg')
...
product.avatar.attach(io: File.open('app/assets/images/product_images/pastel_nike.jpg'), filename: 'pastel_nike.jpg')
...
product.avatar.attach(io: File.open('app/assets/images/product_images/platform.jpg'), filename: 'platform.jpg')
...
product.avatar.attach(io: File.open('app/assets/images/product_images/red_light_up.jpg'), filename: 'red_light_up.jpg')

product = Product.create(title: "Mango Roxanne Red Pumps", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla cursus turpis ac libero maximus facilisis. Morbi ultrices sollicitudin enim et suscipit. Aliquam at facilisis orci. Quisque a diam odio. In sapien felis, ultrices a consequat et, sodales eu neque. Mauris sit amet sapien lectus.", price: 78, gender: "women", brand: "Mango", style: "Pump", colour: "Red", size: 7)
product.avatar.attach(io: File.open('app/assets/images/product_images/red_pumps.jpg'), filename: 'red_pumps.jpg')
